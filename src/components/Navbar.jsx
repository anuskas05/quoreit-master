...
const Navbar = () => {
  ...
  return (
    <nav className="absolute top-0 left-0 w-full z-50 bg-white shadow-sm">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
       <div className="flex items-center justify-center h-16 md:h-20 space-x-10 gap-2">
  ...
  style={{ marginRight: '10px' }} // ✅ Only if needed
  priority
/>
                  ...
                  {item.hasDropdown ? (
                    <div className="relative">
                      <button
                        ...
                        className="text-black hover:text-[#00d9a6] px-2 xl:px-3 py-2 text-xs xl:text-sm font-medium tracking-wide transition-all duration-300 relative group rounded-md hover:scale-110 hover:-translate-y-2 hover:shadow-lg transform-gpu flex items-center"
                      >
              ...
              {item.hasDropdown ? (
                <div className="space-y-1">
                  <button
                    ...
                    className="w-full text-left text-black hover:text-[#00d9a6] flex items-center justify-between px-3 py-2 text-base font-medium tracking-wide transition-all duration-300 relative group rounded-md hover:scale-105 hover:-translate-y-1 hover:shadow-md border-2 border-transparent transform-gpu"
                    style={{
