      ...
      <div className="relative min-h-screen">
        ...
        <div className="relative z-10 min-h-screen flex items-center justify-center">
          <div className="max-w-2xl mx-auto p-8 bg-white bg-opacity-90 rounded-lg shadow-lg backdrop-blur-sm">
            <div className="mb-8">
              <h1 className="text-5xl font-bold text-gray-800 tracking-tight">TECH TALKS</h1>
            </div>
            ...
            <div className="space-y-4 text-gray-700">
              ...
              <p className="text-xl leading-relaxed">
                our podcasts tell the real story of how tech is
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="bg-white rounded-xl shadow-lg overflow-hidden">
            <div className="relative h-64">
              ...
              <div className="absolute bottom-0 left-0 p-8 text-white">
                <h3 className="text-2xl font-bold mb-2">Beyond the Diversity Checklist</h3>
                <p className="text-lg">Embedding True Inclusion in the Workplace</p>
              </div>
            </div>
              ...
              {podcastEpisodes.map((episode) => (
                <div key={episode.id} className="flex justify-between items-center p-4 hover:bg-gray-50 rounded-lg transition-colors">
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      <Link href={episode.link} className="text-lg font-medium text-gray-900 hover:text-blue-600">
                        {episode.title}
                      </Link>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {focusAreas.map((area, index) => (
              <Link 
                href={area.link} 
                key={index}
                className="group block bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300 h-full"
              >
